...
namespace AirlineManagementSystem
{
    class BookingManager
    {
        ...
        public Booking CreateBooking(Flight flight,Passenger passanger,Seat seat,double price)
        {
            string bookingNumber = GenerateBookingNumber();
            var booking = new Booking(bookingNumber, flight, passanger, seat, price);
            lock (lockObject)
            {
